...
[![Version](https://img.shields.io/badge/version-v0.1.0-1a7f37)](https://github.com/fumito100111/ddsm/releases)
...
```bash
python -m pip install git+https://github.com/fumito100111/ddsm.git@v0.1.0
```

> [!TIP]
> If you want to install a specific version, specify it after the `@` symbol.
> For example, to install version `v0.1.0`, use `@v0.1.0`.
